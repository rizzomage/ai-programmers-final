...
* Codes management team - Part of the asset creation process is in identifying data fields which leverage coded data and whether or not new codes, or new domains, need to be created - eg. a 4-digit code that represents, say, a Company Name. An LLM agent can also identify and suggest the necessary updates (applied after human review and approval).
...
* Evaluation - HITL pauses injected between agents to review output before it moves to the next step in the process - eg. structured decision output, suggested schema and/or code domain updates, execution wrapper, etc.
